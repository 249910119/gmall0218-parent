package com.wdl.gmall0218.mock;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.wdl.gmall0218.mock.util.*;
...
public class JsonMocker {
    ...
    RanOpt[] eventOpts= {new RanOpt("addFavor",10),new RanOpt("addComment",30),
            new RanOpt("addCart",20), new RanOpt("clickItem",40), new RanOpt("coupon", 80)
    };
    ...
    String initStartupLog( ){
     ...
     `area` string COMMENT '城市' */
        ...
        String uid=""+ RandomNum.getRandInt(1,20);
